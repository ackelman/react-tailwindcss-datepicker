...
const Years = ({ year, clickYear }) => {
    const { yearPickerStartYearOffset } = React.useContext(DatepickerContext);
    return (React__default["default"].createElement("div", { className: "w-full grid grid-cols-2 gap-2 mt-2" }, generateArrayNumber(year + (yearPickerStartYearOffset || 0), year + (yearPickerStartYearOffset || 0) + 11).map((item, index) => (React__default["default"].createElement(RoundedButton, { key: index, padding: "py-3", onClick: () => {
            clickYear(item);
        } },
        React__default["default"].createElement(React__default["default"].Fragment, null, item))))));
};

const Calendar = ({ date, onClickPrevious, onClickNext, changeMonth, changeYear, showYearPicker }) => {
    // Contexts
    ...
    const [showYears, setShowYears] = React.useState(showYearPicker);
    ...
    const selectDateHelper = React.useCallback((fullDay) => {
        let newStart;
        let newEnd = null;
                ...
                React__default["default"].createElement("div", { className: "mt-2.5 shadow-sm border border-gray-300 px-1 py-0.5 bg-white dark:bg-slate-800 dark:text-white dark:border-slate-600 rounded-lg" },
                    React__default["default"].createElement("div", { className: "flex flex-col lg:flex-row py-2" },
                        ...
                        React__default["default"].createElement("div", { className: `flex items-stretch flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-1.5 ${showShortcuts ? "md:pl-2" : "md:pl-1"} pr-2 lg:pr-1` },
                            React__default["default"].createElement(Calendar, { date: firstDate, onClickPrevious: previousMonthFirst, onClickNext: nextMonthFirst, changeMonth: changeFirstMonth, changeYear: changeFirstYear, showYearPicker: showYearPicker }),
                            useRange && (React__default["default"].createElement(React__default["default"].Fragment, null,
                                ...
                                React__default["default"].createElement(Calendar, { date: secondDate, onClickPrevious: previousMonthSecond, onClickNext: nextMonthSecond, changeMonth: changeSecondMonth, changeYear: changeSecondYear, showYearPicker: showYearPicker }))))),
